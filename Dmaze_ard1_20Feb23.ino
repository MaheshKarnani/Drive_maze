...
//door angles
const int CLOSE_DOOR1 = 90;
const int OPEN_DOOR1 = 141;
const int CLOSE_DOOR2 = 80;
const int OPEN_DOOR2 = 142;
const int CLOSE_DOOR3 = 67;
const int OPEN_DOOR3 = 145;
...
void setup() 
{
  ...
  servo4.write(CLOSE_DOOR4);
  servo5.write(CLOSE_DOOR5);
  servo6.write(CLOSE_DOOR6);
  servo7.write(CLOSE_DOOR7);
  servo8.write(CLOSE_DOOR8);
  servo9.write(CLOSE_DOOR9);
  servo10.write(CLOSE_DOOR10);
  servo11.write(CLOSE_DOOR11);
  servo12.write(CLOSE_DOOR12);
  servo13.write(CLOSE_DOOR13);
  servo14.write(CLOSE_DOOR14);  
  Serial.begin(9600);
...
void moveServo() 
{
  ...
  if (receivedChar=='2' and safe_stage==5) 
  {
    pos14_target=SAFE1_DOOR14;
    safe_stage=1;
  } 

  if (safe_stage==1 and pos14_current==SAFE1_DOOR14)
  {
    pos14_target=SAFE2_DOOR14;
    safe_stage=2;
  }
  if (safe_stage==2 and pos14_current==SAFE2_DOOR14)
  {
    pos14_target=CLOSE_DOOR14;
    safe_stage=3;
  }
    
  if (safe_stage==3 and pos14_current==CLOSE_DOOR14)
  {
    safe_stage=4;
  }
  ...
  {
    pos14_current=pos14_current+1;//closing
  ...
  {
    pos14_current=pos14_current-1;//opening
    servo14.write(pos14_current);     
    delay(social_slowness); 
  }
}
